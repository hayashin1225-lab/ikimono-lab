...
+'@ -replace '(?m)^\+', ''
  ...
  Write-Output 'Windows PowerShell 5.1 entrypoint regression passed: default config path, native UTF-8 gh JSON, native Codex stderr, non-Git smoke flag, README, and Scheduled Task routing.'
} finally {
